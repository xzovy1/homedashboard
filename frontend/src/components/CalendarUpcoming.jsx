...
const Calendar = () => {
    const ID = "0914b87cf9b2178ffd92dc2e09b374a5da1af4b6d72dbf957d6efc5c713e7968@group.calendar.google.com";
    const KEY = "";
    let URL = `https://www.googleapis.com/calendar/v3/calendars/${ID}/events?key=${KEY}` + "&output=embed";

    const CLIENT_ID = '909649312659-vg3r1vnoi5odl1s2vdkfhk0f4nqfk3vb.apps.googleusercontent.com';
    const API_KEY = "";
